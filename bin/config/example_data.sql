...
(1, 1, 100, 50000, '2023-01-01'),
(2, 1, 50, 75000, '2023-02-15'),
(3, 2, 200, 400, '2023-03-10'),
(4, 2, 150, 300, '2023-04-20'),
(5, 3, 100, 2000, '2023-05-05'),
(6, 3, 120, 1800, '2023-06-01'),
(7, 1, 80, 1200, '2023-07-15'),
(8, 2, 60, 18000, '2023-08-20'),
(9, 3, 90, 2700, '2023-09-25'),
(10, 1, 70, 2100, '2023-10-10');
...
(2, 1, 5, '2023-11-01', 300.00, 0),
(3, 2, 3, '2023-11-02', 150.00, 0),
(5, 3, 2, '2023-11-03', 40.00, 0),
(7, 4, 6, '2023-11-04', 240.00, 0),
(9, 5, 4, '2023-11-05', 360.00, 0),
(1, 6, 2, '2023-11-06', 100.00, 0),
(4, 7, 8, '2023-11-07', 320.00, 0),
(6, 8, 5, '2023-11-08', 450.00, 0),
(8, 9, 7, '2023-11-09', 630.00, 0),
(10, 10, 3, '2023-11-10', 90.00, 0);

-- Insert into Returns
INSERT INTO Returns (sale_id, returned_quantity, return_date, reason) VALUES
(1, 1, '2023-11-15', 'Damaged item'),
(3, 1, '2023-11-16', 'Wrong size'),
(7, 2, '2023-11-17', 'Customer changed mind');
